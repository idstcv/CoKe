...
parser.add_argument('--coke-t', default=0.1, type=float,
                    help='temperature (default: 0.1)')
parser.add_argument('--coke-dual-lr', default=20., type=float,
                    help='dual learning rate')
parser.add_argument('--coke-stage', default=801, type=int,
                    help='epochs for stage 1')
parser.add_argument('--coke-tt', default=0.5, type=float,
                    help='softmax temperature for label in stage 2 (default: 0.5)')
parser.add_argument('--coke-ratio', default=0.4, type=float,
                    help='ratio of lower-bound')
parser.add_argument('--coke-ls', default=5, type=int,
                    help='label size in stage 2')
parser.add_argument('--coke-beta', default=0.5, type=float,
                    help='weight of prediction head')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model = coke.builder_single_view.CoKe(
    ...
    train_dataset = coke.folder.ImageFolder(
        traindir,
        coke.loader.SingleCropsTransform(transforms.Compose(aug)))
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        model.module.update_center(epoch)
    ...
    for i, (images, target) in enumerate(train_loader):
        ...
        with autocast():
            ...
            loss = args.coke_beta * loss_pred / args.coke_num_head + (
                        1. - args.coke_beta) * loss_proj / args.coke_num_head
